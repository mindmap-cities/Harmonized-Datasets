...
try({saveOpalTable(o, clsa_cop_total,     "CLSA_COP_Harmonized",  paste0("globe_DS_", last_release),       force = TRUE)})
try({saveOpalTable(o, clsa_tra_total,     "CLSA_TRA_Harmonized",  paste0("globe_DS_", last_release),       force = TRUE)})
