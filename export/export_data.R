...
try({clsa_cop_total  <- applyDictionary(clsa_cop_total,   variables=dd_clsa_cop$Variables,   categories=dd_clsa_cop$Categories)})
try({clsa_tra_total  <- applyDictionary(clsa_tra_total,   variables=dd_clsa_tra$Variables,   categories=dd_clsa_tra$Categories)})
...
#try({saveOpalTable(o, rotterdam_total, "ROTTERDAM_Harmonized",  paste0("rotterdam_DS_2_", last_release),       force = TRUE)})
try({saveOpalTable(o, clsa_cop_total,  "CLSA_Harmonized",  paste0("clsa_cop_DS_2_", last_release),  force = TRUE)})
try({saveOpalTable(o, clsa_tra_total,  "CLSA_Harmonized",  paste0("clsa_tra_DS_2_", last_release),  force = TRUE)})
try({saveOpalTable(o, globe_total,     "GLOBE_Harmonized",  paste0("globe_DS_2_", last_release),       force = TRUE)})
try({saveOpalTable(o, hapiee_cz_total, "HAPIEE_Harmonized", paste0("hapiee_cz_DS_2_", last_release), force = TRUE)})
try({saveOpalTable(o, hapiee_lt_total, "HAPIEE_Harmonized", paste0("hapiee_lt_DS_2_", last_release), force = TRUE)})
try({saveOpalTable(o, hapiee_ru_total, "HAPIEE_Harmonized", paste0("hapiee_ru_DS_2_", last_release), force = TRUE)})
try({saveOpalTable(o, hunt_total,      "HUNT_Harmonized",   paste0("hunt_DS_2_", last_release),      force = TRUE)})
try({saveOpalTable(o, lasa1_total,     "LASA_Harmonized",   paste0("lasa1_DS_2_", last_release),     force = TRUE)})
try({saveOpalTable(o, lasa2_total,     "LASA_Harmonized",   paste0("lasa2_DS_2_", last_release),     force = TRUE)})
try({saveOpalTable(o, lucas_total,     "LUCAS_Harmonized",  paste0("lucas_DS_2_", last_release),     force = TRUE)})
try({saveOpalTable(o, record_total,    "RECORD_Harmonized", paste0("record_DS_2_", last_release),    force = TRUE)})
