...
try({dd_clsa_cop$Variables  <- dd_clsa_cop$Variables  %>% mutate(`index` = 1:nrow(dd_clsa_cop$Variables))})
try({dd_clsa_tra$Variables  <- dd_clsa_tra$Variables  %>% mutate(`index` = 1:nrow(dd_clsa_tra$Variables))})
try({dd_globe$Variables     <- dd_globe$Variables     %>% mutate(`index` = 1:nrow(dd_globe$Variables))})
try({dd_hapiee_cz$Variables <- dd_hapiee_cz$Variables %>% mutate(`index` = 1:nrow(dd_hapiee_cz$Variables))})
try({dd_hapiee_lt$Variables <- dd_hapiee_lt$Variables %>% mutate(`index` = 1:nrow(dd_hapiee_lt$Variables))})
try({dd_hapiee_ru$Variables <- dd_hapiee_ru$Variables %>% mutate(`index` = 1:nrow(dd_hapiee_ru$Variables))})
try({dd_hunt$Variables      <- dd_hunt$Variables      %>% mutate(`index` = 1:nrow(dd_hunt$Variables))})
try({dd_lasa1$Variables     <- dd_lasa1$Variables     %>% mutate(`index` = 1:nrow(dd_lasa1$Variables))})
try({dd_lasa2$Variables     <- dd_lasa2$Variables     %>% mutate(`index` = 1:nrow(dd_lasa2$Variables))})
try({dd_lucas$Variables     <- dd_lucas$Variables     %>% mutate(`index` = 1:nrow(dd_lucas$Variables))})
try({dd_record$Variables    <- dd_record$Variables    %>% mutate(`index` = 1:nrow(dd_record$Variables))})
