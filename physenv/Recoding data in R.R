...
names(physenv_GLOBE_1997) <- gsub("_1997", "_1", names(physenv_GLOBE_1997))

# Recode all _2004 into _2
names(physenv_GLOBE_2004) <- gsub("_2004", "_2", names(physenv_GLOBE_2004))

# Recode all _2011 into _3
names(physenv_GLOBE_2011) <- gsub("_2011", "_3", names(physenv_GLOBE_2011))

# Recode all _2014 into _4
names(physenv_GLOBE_2014) <- gsub("_2014", "_4", names(physenv_GLOBE_2014))
